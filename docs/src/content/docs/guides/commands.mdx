...
| `/gm create\|invite\|leave\|list` (`/groupchat`) | group private messages | `voxen.pm.group` |
| `/gm <text>` | talk to your group | `voxen.pm.group` |
...
| `voxen.pm.group` | using group private messages |
...
| `voxen.mod.alerts` | receiving staff alerts |
